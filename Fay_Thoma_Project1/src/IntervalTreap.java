...
public class IntervalTreap {
	 ...
	 * 
	 * @param z the node to insert into the treap
	 */
	...
	/**
	 * Searching for an interval in the database that overlaps interval i To be
	 * implemented in O(log n) time
	 * 
	 * @param i the given interval
	 * @return Success: an interval that overlaps with i Unsuccessful: return null
	 */
	 ...
	 * @param i interval i
	 * @param x interval x
	 * @return true if intervals overlap false if intervals do not overlap
	 */
	...
	/**
	 * Performs a left rotation on the subtree rooted at x.parent (CLRS) and updates
	 * the iMax fields accordingly
	 * 
	 * @param x the node to left rotate into its parent's spot
	 */
	...
	/**
	 * Performs a right rotation on the subtree rooted at y.parent (CLRS) and
	 * updates the iMax fields accordingly
	 * 
	 * @param x the node to right rotate into its parent's spot
	 */
	...
	/**
	 * Adjusts the iMax value and Height of x based on the rule specified in the
	 * assignment
	 * 
	 * @param x the node to adjust the iMax value and Height of
	 */
	...
	/**
	 * Get the node in the subtree rooted at x that is the left most interval.
	 * 
	 * @param x root left most node in subtree
	 * @return node left most node in subtree
	 */
	 ...
	 * 
	 * @param u node whose subtree needs to be replaced
	 * @param v node whose subtree replaces u's
	 */
...
//		System.out.println("x: (" + x.getInterv().getLow() + " - " + x.getInterv().getHigh() + ")");
	 ...
	 * @param i interval i
	 * @param x interval x
	 * @return true if intervals overlap exactly false if intervals do not overlap
	 *         exactly
	 */
